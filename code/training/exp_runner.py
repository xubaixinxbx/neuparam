...
if __name__ == '__main__':
    ...
    parser.add_argument('--nepoch', type=int, default=8000, help='number of epochs to train for')
    ...
    parser.add_argument('--is_distributed', default=False, action="store_true",
                        help='If set, impletment the distributed version.')
    
    parser.add_argument('--color_id', type=int, default=-1, help='color id specified')
    parser.add_argument('--port', type=int, default=15711, help='ddp port')
